...
String? validateUrlMessage(String raw) {
  final v = raw.trim();
...
class ScrapeStoryBloc extends BaseScrapeBloc<ScrapeStoryRes> {
  ...
  ScrapeStoryBloc({required this.api})
    ...
    validateInput: validateUrlMessage,
...
//       final normalized = normalizeUrl(e.url);
//       final hint = validateUrlMessage(normalized);
//       emit(
//         state.copyWith(
//           url: normalized,
//           urlHint: hint,
...
//   ) async {
//     // ⬇️ Validate first
//     final hint = validateUrlMessage(state.url);
//     if (hint != null) {
//       emit(
//         state.copyWith(
